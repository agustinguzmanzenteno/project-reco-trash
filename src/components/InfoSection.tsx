...
const InfoCard: React.FC<InfoCardProps> = ({ title, description, icon, color }) => (
  <motion.div
    ...
    className={`bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden transform transition-all duration-300 hover:shadow-lg ${color}`}
  >
    <div className="p-6">
      <motion.div
        whileHover="hover"
        ...
        >
          ...
          {activeTab === 'ml' && (
            ...
            >
              ...
              >
                Inteligencia Artificial en la Clasificación
              </motion.h3>
          ...
          {activeTab === 'tips' && (
            ...
            >
              <motion.h3
                ...
                className="text-2xl font-bold mb-4 text-gray-800 dark:text-white"
              >
                Consejos para Gestión de Residuos
              </motion.h3>
